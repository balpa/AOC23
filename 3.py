...
pinput = """........936..672.........846.922........359...332......582..856........................579..93......674..740.....243.156....................
...........%.........4=...*...*........*.......*......#....................806..481.........................*.......*.........900......$564.
...
def checkSurroundings(num, row, index):
    isValid = False
    numLen = len(str(num))
    startPoint = row.index(num)
    if arr[index-1]:
        if startPoint > 0 and startPoint < (len(row) - numLen):
            for x in range(numLen-1, numLen+1):
                if arr[index-1][x] in symbols:
                    isValid = True

for index, row in enumerate(arr):
    nums = getNumbers(row)
    for num in nums:
        res.push(num) if (checkSurroundings(num, row, index)) else 0